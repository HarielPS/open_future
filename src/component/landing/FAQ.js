        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: '100%', md: '70%' } }}
            >
             Los usuarios pueden subir sus facturas pendientes a la plataforma y obtener financiamiento a través del crowdfunding. Las empresas pueden acceder a préstamos utilizando smart contracts y stablecoins. Los inversionistas pueden participar en el financiamiento de facturas y deudas, recibiendo ganancias mensuales a cambio.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion
